...
- Fix gradle tasks parsing [#19](https://github.com/badsyntax/vscode-gradle/issues/19)
- Remove progress notification [#33](https://github.com/badsyntax/vscode-gradle/issues/33)
