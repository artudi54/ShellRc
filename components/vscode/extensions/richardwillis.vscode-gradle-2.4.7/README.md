...
![Screencat](https://github.com/badsyntax/vscode-gradle/raw/master/images/screencast.gif)
...
- [More Features »](https://github.com/badsyntax/vscode-gradle/blob/master/./FEATURES.md)
...
<img src="https://github.com/badsyntax/vscode-gradle/raw/master/./images/output.png" width="600" />

</details>

<details><summary>Task output will be shown in the Terminal panel</summary>

<img src="https://github.com/badsyntax/vscode-gradle/raw/master/./images/terminal.png" width="600" />

</details>

<details><summary>Set the "gradle.debug" setting to "true" to view debug logs in the output panel</summary>

<img src="https://github.com/badsyntax/vscode-gradle/raw/master/./images/debug-output.png" width="600" />

</details>

## Contributing

Refer to [CONTRIBUTING.md](https://github.com/badsyntax/vscode-gradle/blob/master/./CONTRIBUTING.md) for instructions on how to run the project.
...
See [CHANGELOG.md](https://github.com/badsyntax/vscode-gradle/blob/master/./CHANGELOG.md).

## License

See [LICENSE.md](https://github.com/badsyntax/vscode-gradle/blob/master/./LICENSE.md).
