...
images:
	...
	docker image build . -f deployment/docker/Dockerfile-debian --build-arg SYSTEM=ubuntu:22.04 -t artudi54/shellrc:ubuntu-22.04
	docker image build . -f deployment/docker/Dockerfile-debian --build-arg SYSTEM=ubuntu:24.04 -t artudi54/shellrc:ubuntu-24.04
