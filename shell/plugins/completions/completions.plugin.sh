...
if [ -n "$ZSH_VERSION" ]; then
    ...
    source "$SHELLRC_DIR/shell/plugins/completions/git-extras-completion/git-extras-completion.zsh"
    ...
    source "$SHELLRC_DIR/shell/plugins/completions/git-extras-completion/bash_completion.sh"
fi
